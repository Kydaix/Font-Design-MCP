...
Version **0.4.2** adds installation directly from GitHub, with automatic client detection.
...
download from their package index on first installation. Pin a checkout with `github:Kydaix/Font-Design-MCP#v0.4.2`.
